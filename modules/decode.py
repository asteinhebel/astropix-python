...
class Decode:
    ...
    def decode_astropix2_hits(self, list_hits: list, i, file, realTime, print_only:bool = True, csv:bool = False):
        """
        ...
        for hit in list_hits:
            ...
            print(
                ...
                f"ToT: MSB: {tot_msb}\tLSB: {tot_lsb} Total: {tot_total} ({(tot_total * self.sampleclock_period_ns)/1000.0} us) \t Real time (s from epoch): {realTime}"
            )
